...
class WheeledVehicle(RangeMixin):
    def __init__(self,
                 tire_list,
...
# motorboat = Motorboat(1.5, 600)
# print(motorboat.fuel_efficiency)        # 1.5
# print(motorboat.fuel_capacity)          # 600
# print(motorboat.range())                # 900.0
